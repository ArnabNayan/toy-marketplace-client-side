...
const Features = () => {
  ...
  <div className="card-body">
    ...
    <p className='text-slate-700'>Easily Shopping from Online</p>
           ...
           <div className="card w-3/4 bg-base-100 shadow-xl">
  <figure><img src="https://e0.pxfuel.com/wallpapers/153/216/desktop-wallpaper-avengers-assemble-comics-hq-avengers-assemble-2019-avengers-assemble-logo-thumbnail.jpg" alt="Shoes" /></figure>
  <div className="card-body ">
    ...
    <p className='text-slate-700'>Nice and Beautiful toys</p>
           ...
           <div className="card w-3/4 bg-base-100 shadow-xl">
  <figure><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS53sKo2V_1IGBgz7_XFEs9j5-8SOiFqTpz8w&usqp=CAU" alt="Shoes" /></figure>
  <div className="card-body">
    ...
    <p className='text-slate-700'>Call us anytime</p>
           ...
           <div className="card w-3/4 bg-base-100 shadow-xl">
  <figure><img src="https://t3.ftcdn.net/jpg/04/14/78/90/360_F_414789044_6xD0f4z9YcHfQimfnighWoUCIqgEJ66G.jpg" alt="Shoes" /></figure>
  <div className="card-body">
